...
- As miniaturas da Yampi foram removidas do repositorio apos a auditoria por serem pequenas e duplicadas. URLs, dimensoes e pesos permanecem em `src/data/commercialPreview.ts` e `artifacts/final-v2/after/remote-audit.json`.
